...
#ifndef MUJOCO_WITH_ROS2_UI_ADAPTER_H_
#define MUJOCO_WITH_ROS2_UI_ADAPTER_H_
...
class MujocoWithRos2UIAdapter
{
public:
  virtual ~MujocoWithRos2UIAdapter() = default;
...
#endif // MUJOCO_WITH_ROS2_UI_ADAPTER_H_
