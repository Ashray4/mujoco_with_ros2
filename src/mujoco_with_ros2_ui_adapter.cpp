...
MujocoWithRos2UIAdapter::MujocoWithRos2UIAdapter() {
  mjr_defaultContext(&con_);
}

void MujocoWithRos2UIAdapter::FreeMjrContext() {
  mjr_freeContext(&con_);
}

bool MujocoWithRos2UIAdapter::RefreshMjrContext(const mjModel* m, int fontscale) {
...
bool MujocoWithRos2UIAdapter::EnsureContextSize() {
  return false;
}

void MujocoWithRos2UIAdapter::OnFilesDrop(int count, const char** paths) {
...
void MujocoWithRos2UIAdapter::OnKey(int key, int scancode, int act) {
...
void MujocoWithRos2UIAdapter::OnMouseButton(int button, int act)  {
...
void MujocoWithRos2UIAdapter::OnMouseMove(double x, double y) {
...
void MujocoWithRos2UIAdapter::OnScroll(double xoffset, double yoffset) {
  // update state
  UpdateMjuiState();
...
void MujocoWithRos2UIAdapter::OnWindowRefresh() {
...
void MujocoWithRos2UIAdapter::OnWindowResize(int width, int height) {
...
void MujocoWithRos2UIAdapter::UpdateMjuiState() {
  // mouse buttons
